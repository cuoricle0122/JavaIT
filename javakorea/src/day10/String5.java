...
class MyString5 {
	// 프로그램끼리 메시지를 주고 받을때
	// 가격, 제품명, 수량 → 한번에(하나의 문자열) 넘겨야함 〓> 패킷화
	
	private String packet1 = "SAname=A01price=003000num=001ED"; // 아메리카노, 1잔, 1잔에 3000원
	private String packet2 = "SAname=A02price=003500num=002ED"; // 카페라떼, 2잔, 1잔에 3500원
	private String packet3 = "SAname=A03price=004000num=004ED"; // 카페모카, 4잔, 1잔에 4000원
	int price, num, menu_num, price_sum;	// 멤버변수는 자동으로 초기화
